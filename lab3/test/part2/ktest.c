...
// 定义要输出的文件
#define OUTPUT_FILE "/home/minerva/oslab/lab3/test/part2/expr_result.txt"
...
static my_page_referenced mpage_referenced = (my_page_referenced)0xffffffff9b308f80;
// sudo cat /proc/kallsyms | grep follow_page
static my_follow_page mfollow_page = (my_follow_page)0xffffffff9b2ea580;
...
static unsigned int ktest_func = 1;
